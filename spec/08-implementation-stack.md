...
| LLM Layer — Curator Agent / Classifier | [01](01-architecture-and-data-model.md) §1, [07](07-additional-features-and-roadmap.md) §1 | Pydantic AI |
...
- Its model-provider abstraction keeps the LLM provider swappable, consistent with
  [00](00-overview.md) §3's "LLM provider out of scope."
